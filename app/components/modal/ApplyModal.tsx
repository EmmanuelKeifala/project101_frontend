...
import useBirthApplyModal from "@/app/hooks/useApplyModal";
...
import { categoryOption } from "../Navbar/Categories";
...
const BirthModal = () => {
	...
	const birthModal = useBirthApplyModal();
